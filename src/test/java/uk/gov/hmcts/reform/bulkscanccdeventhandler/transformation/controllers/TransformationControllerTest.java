...
public class TransformationControllerTest {
    ...
    void should_return_case_data_if_transformation_succeeded() throws Exception {
        ...
        sendRequest("{}")
            ...
            .andExpect(jsonPath("$.case_creation_details.case_data.scannedDocuments[0].value.url.document_filename").value("filename-1"))
            .andExpect(jsonPath("$.case_creation_details.case_data.scannedDocuments[0].value.url.document_binary_url").value("url-binary-1"))
            ...
            .andExpect(jsonPath("$.case_creation_details.case_data.scannedDocuments[1].value.url.document_filename").value("filename-2"))
            .andExpect(jsonPath("$.case_creation_details.case_data.scannedDocuments[1].value.url.document_binary_url").value("url-binary-2"))
